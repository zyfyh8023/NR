...
page.viewportSize = { width: 2000, height: 5000000 };
...
*/
    ...
    if(origin_urlinfo['script'].length>0){
        ...
        if(script){
            ...
            var i=0;
            // console.log(origin_urlinfo['url']);
            ...
            var timer1=setInterval(function(){
                ...
                page.render(origin_urlinfo['url']+'-------'+i+'.png');
